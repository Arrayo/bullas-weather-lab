...
const output = { schemaVersion: 1, stationId, collectionCount: collectionCount?.count ?? 0, collectionsByStatus, forecastsByModel, observations: observations ?? { count: 0, first_observed_at: null, last_observed_at: null }, sqliteSizeBytes, runsByStatus };
